...
<div class="relative flex min-h-screen items-center justify-center p-4 sm:p-6 md:p-8">
    ...
    >
        ...
        <p class="mt-4 text-xs sm:text-sm text-gray-400 italic group-hover:text-gray-600 transition-colors">
...
<div class="fixed bottom-4 sm:bottom-8 right-4 sm:right-8 z-50">
    @if(!$showForm)
        <button wire:click="toggleForm" class="group flex items-center gap-2 rounded-full bg-yellow-500 px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-yellow-600 hover:shadow-xl active:scale-95">
    ...
    @else
        ...
        >
            <div class="mb-4 flex items-center justify-between">
                ...
                <button wire:click="toggleForm" class="text-gray-400 transition-colors hover:text-gray-600 p-1">
